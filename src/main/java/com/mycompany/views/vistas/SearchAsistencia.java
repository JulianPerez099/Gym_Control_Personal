...
public class SearchAsistencia extends javax.swing.JPanel {

    public SearchAsistencia() {
        initComponents();
        InitStyles();
        LoadAsistencia();
    }
    ...
    private void InitStyles() {
        ...
        Buscar.putClientProperty("JTextField.placeholderText", "Ingrese el usuario a buscar.");
    }
    ...
    private void LoadAsistencia() {
        try {
            ...
            dao.listar("", "", "", "").forEach((u -> model.addRow(new Object[]{u.getID_Entrenamiento(), u.getNombre_Usuario(), u.getApellido_Usuario(), u.getTelefono_Usuario(), u.getDebe(), u.getTotal_Deuda(), u.getFecha_de_Entrenamiento()})));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Telefono", "Debe", "Cuanto", "Fecha Entrenamiento"
            }
        ) {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            Dashboard.ShowPanel(new AddAsistencia());
        } catch (Exception ex) {
            Logger.getLogger(SearchAsistencia.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        try {
            int ID_Entrenamiento = 1; // ID predeterminado
            DAOasistencia dao = new DAOasistenciaImpl();
            Dashboard.ShowPanel(new DetalladoAsistencia(dao.getAsistenciaById(ID_Entrenamiento)));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(Buscar.getText(), Buscar.getText(), Buscar.getText(), Buscar.getText()).forEach((u -> model.addRow(new Object[]{
                u.getID_Entrenamiento(), u.getNombre_Usuario(), u.getApellido_Usuario(), u.getApellido_Usuario(), u.getDebe(), u.getTotal_Deuda(), u.getFecha_de_Entrenamiento()})));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
