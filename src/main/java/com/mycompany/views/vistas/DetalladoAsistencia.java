...
public class DetalladoAsistencia extends javax.swing.JPanel {

    public DetalladoAsistencia(Asistencia asistenciaById) {
        initComponents();
        LoadDetails();
        InitStyles();
    }
    ...
    private void LoadDetails() {
        try {
            ...
            final List<Asistencia> usuarios = dao.listar("", "", "", "");
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (Asistencia u : usuarios) {
                        if (u.getID_Entrenamiento() == id) {
                            ...
                            Estado.setSelectedItem(u.getDebe());
                            Total.setText(Double.toString(u.getTotal_Deuda()));
                            try {
                                Fecha_de_Entrenamiento.setDate(new SimpleDateFormat("dd/MM/yyyy").parse(u.getFecha_de_Entrenamiento()));
                            } catch (ParseException ex) {
                                System.out.println("Error al parsear fecha: " + ex.getMessage());
                            }
                            Ejercicio1.setSelectedItem(u.getEjercicio_1());
                            Ejercicio2.setSelectedItem(u.getEjercicio_2());
                            Ejercicio3.setSelectedItem(u.getEjercicio_3());
                            Ejercicio4.setSelectedItem(u.getEjercicio_4());
                            Ejercicio5.setSelectedItem(u.getEjercicio_5());
                            Ejercicio16.setSelectedItem(u.getEjercicio_6());
                            Ejercicio17.setSelectedItem(u.getEjercicio_7());
                            Ejercicio18.setSelectedItem(u.getEjercicio_8());
                            Ejercicio19.setSelectedItem(u.getEjercicio_9());
                            Ejercicio20.setSelectedItem(u.getEjercicio_10());
                            Ejercicio21.setSelectedItem(u.getEjercicio_11());
                            Ejercicio22.setSelectedItem(u.getEjercicio_12());
                            Ejercicio23.setSelectedItem(u.getEjercicio_13());
                            Ejercicio24.setSelectedItem(u.getEjercicio_14());
                            Ejercicio25.setSelectedItem(u.getEjercicio_15());

                            Tiempo1.setSelectedItem(u.getTiempo_1());
                            Tiempo2.setSelectedItem(u.getTiempo_2());
                            Tiempo3.setSelectedItem(u.getTiempo_3());
                            Tiempo4.setSelectedItem(u.getTiempo_4());
                            Tiempo5.setSelectedItem(u.getTiempo_5());
                            Tiempo16.setSelectedItem(u.getTiempo_6());
                            Tiempo17.setSelectedItem(u.getTiempo_7());
                            Tiempo18.setSelectedItem(u.getTiempo_8());
                            Tiempo19.setSelectedItem(u.getTiempo_9());
                            Tiempo20.setSelectedItem(u.getTiempo_10());
                            Tiempo21.setSelectedItem(u.getTiempo_11());
                            Tiempo22.setSelectedItem(u.getTiempo_12());
                            Tiempo23.setSelectedItem(u.getTiempo_13());
                            Tiempo24.setSelectedItem(u.getTiempo_14());
                            Tiempo25.setSelectedItem(u.getTiempo_15());

                            Repeticiones1.setSelectedItem(u.getRepeticion_1());
                            Repeticiones2.setSelectedItem(u.getRepeticion_2());
                            Repeticiones3.setSelectedItem(u.getRepeticion_3());
                            Repeticiones4.setSelectedItem(u.getRepeticion_4());
                            Repeticiones5.setSelectedItem(u.getRepeticion_5());
                            Repeticiones6.setSelectedItem(u.getRepeticion_6());
                            Repeticiones7.setSelectedItem(u.getRepeticion_7());
                            Repeticiones8.setSelectedItem(u.getRepeticion_8());
                            Repeticiones9.setSelectedItem(u.getRepeticion_9());
                            Repeticiones10.setSelectedItem(u.getRepeticion_10());
                            Repeticiones11.setSelectedItem(u.getRepeticion_11());
                            Repeticiones12.setSelectedItem(u.getRepeticion_12());
                            Repeticiones13.setSelectedItem(u.getRepeticion_13());
                            Repeticiones14.setSelectedItem(u.getRepeticion_14());
                            Repeticiones15.setSelectedItem(u.getRepeticion_15());

                            Series.setSelectedItem(u.getSerie_1());
                            Series1.setSelectedItem(u.getSerie_2());
                            Series2.setSelectedItem(u.getSerie_3());
                            break;
                        }
                    }
                }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(758, 429));
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        //Validacion
        Asistencia user = new Asistencia();
