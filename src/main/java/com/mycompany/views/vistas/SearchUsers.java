...
public class SearchUsers extends javax.swing.JPanel {
    ...
    private void LoadUsers() {
        try {
            ...
            dao.listar("", "").forEach((u -> model.addRow(new Object[]{u.getID_Usuario(),
                u.getNombre_Usuario(), u.getApellido_Usuario(), u.getFecha_Nacimiento_Usuario(), u.getPeso_Usuario(),
                u.getTalla_Usuario(), u.getPerimetro_Usuario(), u.getIMC_Usuario(), u.getTelefono_Usuario(),
                u.getTelefono_Emergencia_Usuario(),u.getEnfermedades_Usuario(),u.getLesiones_Usuario(),u.getMedicamentos_Usuario()})));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Fecha de Nacimiento", "Peso", "Talla", "Perimetro", "IMC", "Contacto", "Contacto de Emergencia", "Enfermedades", "Lesiones", "Medicamentos"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
            };
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            Dashboard.ShowPanel(new AddUser());
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                int ID_Usuario = (int) jTable1.getValueAt(jTable1.getSelectedRow(), 0);
                DAOpersonal dao = new DAOpersonalImpl();

                Dashboard.ShowPanel(new AddUser(dao.getPersonalById(ID_Usuario)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(userSearch.getText(), userSearch.getText()).forEach((u -> model.addRow
        (new Object[]{u.getID_Usuario(),
                u.getNombre_Usuario(), u.getApellido_Usuario(), u.getFecha_Nacimiento_Usuario(), u.getPeso_Usuario(),
                u.getTalla_Usuario(), u.getPerimetro_Usuario(), u.getIMC_Usuario(), u.getTelefono_Usuario(),
                u.getTelefono_Emergencia_Usuario(),u.getEnfermedades_Usuario(),u.getLesiones_Usuario(),u.getMedicamentos_Usuario()})));
        } catch (Exception e) {
